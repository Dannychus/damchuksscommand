...
echo $i" |"$cy"     9ja | INDONESIA DARK TERMUX ASSOCIATE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" HACKORZPRIME  [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Thomas Matteo"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [Hackorzprime] [MR.S∆MAx] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [Hackorzprime]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" +2347040682131"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" harshhackgang0507@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" +234704068213"
echo $ku" Associate Individual Facebook :"$i" Riski Darmawan"
sleep 2
